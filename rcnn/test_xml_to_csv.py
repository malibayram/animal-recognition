...
class XMLToCSVTest(unittest.TestCase):
    def test_one_raccoon_one_xml(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            self.assertEqual(raccoon_df.values.tolist()[0], [
                             'raccoon-1.png', 256, 256, 'raccoon', 96, 96, 128, 128])
    ...
    def test_multiple_raccoon_one_xml(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            self.assertEqual(raccoon_df.values.tolist()[0], [
                             'raccoon-1.png', 256, 256, 'raccoon', 96, 96, 128, 128])
            self.assertEqual(raccoon_df.values.tolist()[1], [
                             'raccoon-1.png', 256, 256, 'raccoon', 32, 32, 64, 64])
    ...
    def test_one_raccoon_multiple_xml(self):
        ...
        self.assertEqual(raccoon_df.values.tolist()[0], [
                         'raccoon-1.png', 256, 256, 'raccoon', 96, 96, 128, 128])
        self.assertEqual(raccoon_df.values.tolist()[1], [
                         'raccoon-2.png', 256, 256, 'raccoon', 128, 128, 194, 194])
